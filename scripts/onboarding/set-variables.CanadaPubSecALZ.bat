...
set DEVOPS_TENANT_ID=df968f64-5f44-4e42-937b-47fb792ee373
...
set DEVOPS_REPO_BRANCH=skeeler-quicksetup
...
set DEVOPS_SE_TEMPLATE=service-endpoint.CanadaPubSecALZ.json
